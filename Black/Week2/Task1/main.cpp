...
public:
    ObjectValueContext(std::ostream& ostream, T& ret) : PrintContext<T>(ostream, ret) {}
    ...
    T& String(std::string str){
        this->PrintString(str);
        return this->Ret();
    }

    T& Boolean(bool boolean){
        this->PrintBoolean(boolean);
        return this->Ret();
    }
...
public:
    ObjectKeyContext(std::ostream& ostream, T& ret) : PrintContext<T>(ostream, ret){
        ostream << '{';
    }
    ...
    ObjectValueContext<ObjectKeyContext<T>> Key(const std::string_view key){
        ...
        return ObjectValueContext<ObjectKeyContext<T>>(this->Stream() << ':', *this);
    }
...
public:
    ...
    ArrayContext& String(std::string str){
        this->PrintString(str);
        return *this;
    }

    ArrayContext& Boolean(bool boolean){
        this->PrintBoolean(boolean);
        return *this;
    }
