...
class StopsCompressed PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ProtoTransport.StopsCompressed) */ {
 public:
  inline StopsCompressed() : StopsCompressed(nullptr) {}
  ...
  inline void Swap(StopsCompressed* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(StopsCompressed* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  StopsCompressed* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ProtoTransport.StopsCompressed";
  }
  protected:
  explicit StopsCompressed(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
class Renderer PROTOBUF_FINAL :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::ProtoTransport::StopsCompressed >*
      mutable_stops();
  private:
  const ::ProtoTransport::StopsCompressed& _internal_stops(int index) const;
  ::ProtoTransport::StopsCompressed* _internal_add_stops();
  public:
  const ::ProtoTransport::StopsCompressed& stops(int index) const;
  ::ProtoTransport::StopsCompressed* add_stops();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::ProtoTransport::StopsCompressed >&
      stops() const;
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::ProtoTransport::StopsCompressed > stops_;
...
inline const std::string& StopsCompressed::_internal_name() const {
  return name_.Get();
}
inline void StopsCompressed::_internal_set_name(const std::string& value) {
...
inline std::string* StopsCompressed::_internal_mutable_name() {
...
inline double StopsCompressed::_internal_lat() const {
  return lat_;
}
...
inline void StopsCompressed::_internal_set_lat(double value) {
...
inline double StopsCompressed::_internal_lon() const {
  return lon_;
}
...
inline void StopsCompressed::_internal_set_lon(double value) {
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::ProtoTransport::StopsCompressed >*
Renderer::mutable_stops() {
  // @@protoc_insertion_point(field_mutable_list:ProtoTransport.Renderer.stops)
  return &stops_;
}
inline const ::ProtoTransport::StopsCompressed& Renderer::_internal_stops(int index) const {
...
inline ::ProtoTransport::StopsCompressed* Renderer::_internal_add_stops() {
  return stops_.Add();
}
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::ProtoTransport::StopsCompressed >&
