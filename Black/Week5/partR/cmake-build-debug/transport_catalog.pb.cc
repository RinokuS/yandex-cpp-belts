...
extern PROTOBUF_INTERNAL_EXPORT_db_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_Db_db_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_renderer_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_Renderer_renderer_2eproto;
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_transport_5fcatalog_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::ProtoTransport::TransportCatalog, yp_),
};
...
const char descriptor_table_protodef_transport_5fcatalog_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "o\032\016database.proto\"\251\001\n\020TransportCatalog\022\036"
  "\n\002db\030\001 \001(\0132\022.ProtoTransport.Db\022&\n\006router"
  "\030\002 \001(\0132\026.ProtoTransport.Router\022*\n\010render"
  "er\030\003 \001(\0132\030.ProtoTransport.Renderer\022!\n\002yp"
  "\030\004 \001(\0132\025.YellowPages.Databaseb\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_transport_5fcatalog_2eproto_deps[4] = {
  &::descriptor_table_database_2eproto,
  &::descriptor_table_db_2eproto,
  &::descriptor_table_renderer_2eproto,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_transport_5fcatalog_2eproto = {
  false, false, descriptor_table_protodef_transport_5fcatalog_2eproto, "transport_catalog.proto", 277,
  &descriptor_table_transport_5fcatalog_2eproto_once, descriptor_table_transport_5fcatalog_2eproto_sccs, descriptor_table_transport_5fcatalog_2eproto_deps, 1, 4,
...
void TransportCatalog::InitAsDefaultInstance() {
  ...
  ::ProtoTransport::_TransportCatalog_default_instance_._instance.get_mutable()->yp_ = const_cast< ::YellowPages::Database*>(
      ::YellowPages::Database::internal_default_instance());
}
class TransportCatalog::_Internal {
 public:
  ...
  static const ::YellowPages::Database& yp(const TransportCatalog* msg);
};
...
TransportCatalog::_Internal::yp(const TransportCatalog* msg) {
  return *msg->yp_;
}
...
void TransportCatalog::clear_yp() {
  if (GetArena() == nullptr && yp_ != nullptr) {
    delete yp_;
  }
  yp_ = nullptr;
}
...
TransportCatalog::TransportCatalog(const TransportCatalog& from)
  ...
  if (from._internal_has_yp()) {
    yp_ = new ::YellowPages::Database(*from.yp_);
  } else {
    yp_ = nullptr;
  }
...
void TransportCatalog::SharedCtor() {
  ...
  ::memset(&db_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&yp_) -
      reinterpret_cast<char*>(&db_)) + sizeof(yp_));
}
...
void TransportCatalog::SharedDtor() {
  ...
  if (this != internal_default_instance()) delete yp_;
}
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 34)) {
          ptr = ctx->ParseMessage(_internal_mutable_yp(), ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* TransportCatalog::_InternalSerialize(
  ...
  if (this->has_renderer()) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        3, _Internal::renderer(this), target, stream);
  }
  ...
  if (this->has_yp()) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        4, _Internal::yp(this), target, stream);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:ProtoTransport.TransportCatalog)
  ...
  if (from.has_db()) {
    _internal_mutable_db()->::ProtoTransport::Db::MergeFrom(from._internal_db());
  }
  if (from.has_router()) {
    _internal_mutable_router()->::ProtoTransport::Router::MergeFrom(from._internal_router());
  }
  if (from.has_renderer()) {
    _internal_mutable_renderer()->::ProtoTransport::Renderer::MergeFrom(from._internal_renderer());
  }
  if (from.has_yp()) {
    _internal_mutable_yp()->::YellowPages::Database::MergeFrom(from._internal_yp());
  }
}
...
void TransportCatalog::InternalSwap(TransportCatalog* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(TransportCatalog, yp_)
      + sizeof(TransportCatalog::yp_)
