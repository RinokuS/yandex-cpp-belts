...
extern PROTOBUF_INTERNAL_EXPORT_renderer_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_StopsCompressed_renderer_2eproto;
...
class StopsCompressedDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<StopsCompressed> _instance;
...
static void InitDefaultsscc_info_StopsCompressed_renderer_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_StopsCompressed_renderer_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_StopsCompressed_renderer_2eproto}, {}};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::ProtoTransport::_StopsCompressed_default_instance_),
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_renderer_2eproto = {
  false, false, descriptor_table_protodef_renderer_2eproto, "renderer.proto", 906,
...
class StopsCompressed::_Internal {
 public:
};

StopsCompressed::StopsCompressed(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:ProtoTransport.StopsCompressed)
}
...
void StopsCompressed::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_StopsCompressed_renderer_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void StopsCompressed::ArenaDtor(void* object) {
  StopsCompressed* _this = reinterpret_cast< StopsCompressed* >(object);
  (void)_this;
}
void StopsCompressed::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
const char* StopsCompressed::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena(); (void)arena;
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "ProtoTransport.StopsCompressed.name"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // double lat = 2;
...
::PROTOBUF_NAMESPACE_ID::uint8* StopsCompressed::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
void StopsCompressed::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:ProtoTransport.StopsCompressed)
  GOOGLE_DCHECK_NE(&from, this);
  const StopsCompressed* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<StopsCompressed>(
          &from);
  if (source == nullptr) {
...
void StopsCompressed::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
void StopsCompressed::InternalSwap(StopsCompressed* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(StopsCompressed, lon_)
      + sizeof(StopsCompressed::lon_)
      - PROTOBUF_FIELD_OFFSET(StopsCompressed, lat_)>(
          reinterpret_cast<char*>(&lat_),
          reinterpret_cast<char*>(&other->lat_));
}

::PROTOBUF_NAMESPACE_ID::Metadata StopsCompressed::GetMetadata() const {
  return GetMetadataStatic();
}
...
template<> PROTOBUF_NOINLINE ::ProtoTransport::StopsCompressed* Arena::CreateMaybeMessage< ::ProtoTransport::StopsCompressed >(Arena* arena) {
  return Arena::CreateMessageInternal< ::ProtoTransport::StopsCompressed >(arena);
}
