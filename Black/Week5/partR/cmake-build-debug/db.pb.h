...
template<> ::ProtoTransport::Db* Arena::CreateMaybeMessage<::ProtoTransport::Db>(Arena*);
...
class Buses PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  bool _internal_route_type() const;
  void _internal_set_route_type(bool value);
  public:
...
class Db PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ProtoTransport.Db) */ {
 public:
  ...
  inline Db* New() const final {
    return CreateMaybeMessage<Db>(nullptr);
  }

  Db* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  // @@protoc_insertion_point(class_scope:ProtoTransport.Db)
 private:
  class _Internal;
...
// repeated string route = 6;
inline int Buses::_internal_route_size() const {
  return route_.size();
}
...
inline const std::string& Buses::_internal_route(int index) const {
...
inline std::string* Buses::_internal_add_route() {
  return route_.Add();
}
...
inline bool Buses::_internal_route_type() const {
  return route_type_;
}
...
inline void Buses::_internal_set_route_type(bool value) {
...
// repeated .ProtoTransport.Stops stops = 1;
inline int Db::_internal_stops_size() const {
  return stops_.size();
}
inline int Db::stops_size() const {
  return _internal_stops_size();
}
inline void Db::clear_stops() {
  stops_.Clear();
}
inline ::ProtoTransport::Stops* Db::mutable_stops(int index) {
  // @@protoc_insertion_point(field_mutable:ProtoTransport.Db.stops)
  return stops_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::ProtoTransport::Stops >*
Db::mutable_stops() {
  // @@protoc_insertion_point(field_mutable_list:ProtoTransport.Db.stops)
  return &stops_;
}
inline const ::ProtoTransport::Stops& Db::_internal_stops(int index) const {
  return stops_.Get(index);
}
inline const ::ProtoTransport::Stops& Db::stops(int index) const {
  // @@protoc_insertion_point(field_get:ProtoTransport.Db.stops)
  return _internal_stops(index);
}
inline ::ProtoTransport::Stops* Db::_internal_add_stops() {
  return stops_.Add();
}
inline ::ProtoTransport::Stops* Db::add_stops() {
  // @@protoc_insertion_point(field_add:ProtoTransport.Db.stops)
  return _internal_add_stops();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::ProtoTransport::Stops >&
Db::stops() const {
  // @@protoc_insertion_point(field_list:ProtoTransport.Db.stops)
  return stops_;
}

// repeated .ProtoTransport.Buses buses = 2;
inline int Db::_internal_buses_size() const {
  return buses_.size();
}
inline int Db::buses_size() const {
  return _internal_buses_size();
}
inline void Db::clear_buses() {
  buses_.Clear();
}
inline ::ProtoTransport::Buses* Db::mutable_buses(int index) {
  // @@protoc_insertion_point(field_mutable:ProtoTransport.Db.buses)
  return buses_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::ProtoTransport::Buses >*
Db::mutable_buses() {
  // @@protoc_insertion_point(field_mutable_list:ProtoTransport.Db.buses)
  return &buses_;
}
inline const ::ProtoTransport::Buses& Db::_internal_buses(int index) const {
  return buses_.Get(index);
}
inline const ::ProtoTransport::Buses& Db::buses(int index) const {
  // @@protoc_insertion_point(field_get:ProtoTransport.Db.buses)
  return _internal_buses(index);
}
inline ::ProtoTransport::Buses* Db::_internal_add_buses() {
  return buses_.Add();
}
inline ::ProtoTransport::Buses* Db::add_buses() {
  // @@protoc_insertion_point(field_add:ProtoTransport.Db.buses)
  return _internal_add_buses();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::ProtoTransport::Buses >&
Db::buses() const {
  // @@protoc_insertion_point(field_list:ProtoTransport.Db.buses)
  return buses_;
}
