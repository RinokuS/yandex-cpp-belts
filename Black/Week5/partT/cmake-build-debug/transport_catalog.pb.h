...
class TransportCatalog PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  const ::ProtoTransport::Db& _internal_db() const;
  ::ProtoTransport::Db* _internal_mutable_db();
  public:
  void unsafe_arena_set_allocated_db(
      ::ProtoTransport::Db* db);
  ::ProtoTransport::Db* unsafe_arena_release_db();
  ...
  // .YellowPages.Database yp = 4;
  bool has_yp() const;
  private:
  bool _internal_has_yp() const;
  public:
  void clear_yp();
  const ::YellowPages::Database& yp() const;
  ::YellowPages::Database* release_yp();
  ::YellowPages::Database* mutable_yp();
  void set_allocated_yp(::YellowPages::Database* yp);
  private:
  const ::YellowPages::Database& _internal_yp() const;
  ::YellowPages::Database* _internal_mutable_yp();
  public:
  void unsafe_arena_set_allocated_yp(
      ::YellowPages::Database* yp);
  ::YellowPages::Database* unsafe_arena_release_yp();
...
inline const ::ProtoTransport::Db& TransportCatalog::_internal_db() const {
...
inline ::ProtoTransport::Db* TransportCatalog::unsafe_arena_release_db() {
...
inline ::ProtoTransport::Db* TransportCatalog::_internal_mutable_db() {
  
  if (db_ == nullptr) {
    auto* p = CreateMaybeMessage<::ProtoTransport::Db>(GetArena());
    db_ = p;
  }
  return db_;
}
...
// .YellowPages.Database yp = 4;
inline bool TransportCatalog::_internal_has_yp() const {
  return this != internal_default_instance() && yp_ != nullptr;
}
inline bool TransportCatalog::has_yp() const {
  return _internal_has_yp();
}
inline const ::YellowPages::Database& TransportCatalog::_internal_yp() const {
  const ::YellowPages::Database* p = yp_;
  return p != nullptr ? *p : *reinterpret_cast<const ::YellowPages::Database*>(
      &::YellowPages::_Database_default_instance_);
}
inline const ::YellowPages::Database& TransportCatalog::yp() const {
  // @@protoc_insertion_point(field_get:ProtoTransport.TransportCatalog.yp)
  return _internal_yp();
}
inline void TransportCatalog::unsafe_arena_set_allocated_yp(
    ::YellowPages::Database* yp) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(yp_);
  }
  yp_ = yp;
  if (yp) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ProtoTransport.TransportCatalog.yp)
}
inline ::YellowPages::Database* TransportCatalog::release_yp() {
  
  ::YellowPages::Database* temp = yp_;
  yp_ = nullptr;
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
...
inline ::YellowPages::Database* TransportCatalog::unsafe_arena_release_yp() {
  // @@protoc_insertion_point(field_release:ProtoTransport.TransportCatalog.yp)
  
  ::YellowPages::Database* temp = yp_;
  yp_ = nullptr;
  return temp;
}
inline ::YellowPages::Database* TransportCatalog::_internal_mutable_yp() {
...
inline ::YellowPages::Database* TransportCatalog::mutable_yp() {
  // @@protoc_insertion_point(field_mutable:ProtoTransport.TransportCatalog.yp)
  return _internal_mutable_yp();
}
inline void TransportCatalog::set_allocated_yp(::YellowPages::Database* yp) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(yp_);
  }
  if (yp) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(yp)->GetArena();
    if (message_arena != submessage_arena) {
      yp = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, yp, submessage_arena);
    }
  ...
  yp_ = yp;
  // @@protoc_insertion_point(field_set_allocated:ProtoTransport.TransportCatalog.yp)
}
