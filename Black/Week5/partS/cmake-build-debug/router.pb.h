...
enum EdgeInfo_EdgeType : int {
  EdgeInfo_EdgeType_WaitBus = 0,
  EdgeInfo_EdgeType_RideBus = 1,
  EdgeInfo_EdgeType_WalkToCompany = 2,
  EdgeInfo_EdgeType_EdgeInfo_EdgeType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  EdgeInfo_EdgeType_EdgeInfo_EdgeType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool EdgeInfo_EdgeType_IsValid(int value);
constexpr EdgeInfo_EdgeType EdgeInfo_EdgeType_EdgeType_MIN = EdgeInfo_EdgeType_WaitBus;
constexpr EdgeInfo_EdgeType EdgeInfo_EdgeType_EdgeType_MAX = EdgeInfo_EdgeType_WalkToCompany;
constexpr int EdgeInfo_EdgeType_EdgeType_ARRAYSIZE = EdgeInfo_EdgeType_EdgeType_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* EdgeInfo_EdgeType_descriptor();
template<typename T>
inline const std::string& EdgeInfo_EdgeType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, EdgeInfo_EdgeType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function EdgeInfo_EdgeType_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    EdgeInfo_EdgeType_descriptor(), enum_t_value);
}
inline bool EdgeInfo_EdgeType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, EdgeInfo_EdgeType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<EdgeInfo_EdgeType>(
    EdgeInfo_EdgeType_descriptor(), name, value);
}
// ===================================================================
...
class EdgeInfo PROTOBUF_FINAL :
 ...
 public:
  ...
  typedef EdgeInfo_EdgeType EdgeType;
  static constexpr EdgeType WaitBus =
    EdgeInfo_EdgeType_WaitBus;
  static constexpr EdgeType RideBus =
    EdgeInfo_EdgeType_RideBus;
  static constexpr EdgeType WalkToCompany =
    EdgeInfo_EdgeType_WalkToCompany;
  static inline bool EdgeType_IsValid(int value) {
    return EdgeInfo_EdgeType_IsValid(value);
  }
  static constexpr EdgeType EdgeType_MIN =
    EdgeInfo_EdgeType_EdgeType_MIN;
  static constexpr EdgeType EdgeType_MAX =
    EdgeInfo_EdgeType_EdgeType_MAX;
  static constexpr int EdgeType_ARRAYSIZE =
    EdgeInfo_EdgeType_EdgeType_ARRAYSIZE;
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  EdgeType_descriptor() {
    return EdgeInfo_EdgeType_descriptor();
  }
  template<typename T>
  static inline const std::string& EdgeType_Name(T enum_t_value) {
    ...
    return EdgeInfo_EdgeType_Name(enum_t_value);
  }
  static inline bool EdgeType_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      EdgeType* value) {
    return EdgeInfo_EdgeType_Parse(name, value);
  }
  ...
  void clear_type();
  ::ProtoTransport::EdgeInfo_EdgeType type() const;
  void set_type(::ProtoTransport::EdgeInfo_EdgeType value);
  private:
  ::ProtoTransport::EdgeInfo_EdgeType _internal_type() const;
  void _internal_set_type(::ProtoTransport::EdgeInfo_EdgeType value);
  public:
...
inline ::ProtoTransport::EdgeInfo_EdgeType EdgeInfo::_internal_type() const {
  return static_cast< ::ProtoTransport::EdgeInfo_EdgeType >(type_);
}
inline ::ProtoTransport::EdgeInfo_EdgeType EdgeInfo::type() const {
  // @@protoc_insertion_point(field_get:ProtoTransport.EdgeInfo.type)
  return _internal_type();
}
inline void EdgeInfo::_internal_set_type(::ProtoTransport::EdgeInfo_EdgeType value) {
  
  type_ = value;
}
inline void EdgeInfo::set_type(::ProtoTransport::EdgeInfo_EdgeType value) {
...
inline const std::string& EdgeInfo::company_name() const {
  // @@protoc_insertion_point(field_get:ProtoTransport.EdgeInfo.company_name)
...
inline void EdgeInfo::set_company_name(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:ProtoTransport.EdgeInfo.company_name)
}
inline std::string* EdgeInfo::mutable_company_name() {
  // @@protoc_insertion_point(field_mutable:ProtoTransport.EdgeInfo.company_name)
...
inline void EdgeInfo::set_company_name(std::string&& value) {
  ...
  company_name_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:ProtoTransport.EdgeInfo.company_name)
}
inline void EdgeInfo::set_company_name(const char* value) {
  ...
  company_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:ProtoTransport.EdgeInfo.company_name)
}
inline void EdgeInfo::set_company_name(const char* value,
    size_t size) {
  ...
  company_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:ProtoTransport.EdgeInfo.company_name)
}
...
inline std::string* EdgeInfo::release_company_name() {
  // @@protoc_insertion_point(field_release:ProtoTransport.EdgeInfo.company_name)
...
inline void EdgeInfo::set_allocated_company_name(std::string* company_name) {
  ...
  company_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), company_name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:ProtoTransport.EdgeInfo.company_name)
}
...
template <> struct is_proto_enum< ::ProtoTransport::EdgeInfo_EdgeType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::ProtoTransport::EdgeInfo_EdgeType>() {
  return ::ProtoTransport::EdgeInfo_EdgeType_descriptor();
}
