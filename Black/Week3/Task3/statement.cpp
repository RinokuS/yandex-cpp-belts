...
Assignment::Assignment(std::string var, std::unique_ptr<Statement> rv) : var_name(std::move(var)),
...
ClassDefinition::ClassDefinition(ObjectHolder class_) : cls(std::move(class_)),
